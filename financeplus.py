...
if col4 == "INDICADORES NÍVEL II ":
    ...
    siglas = ['SHIBUSDT','DOGEBTC','IOTXBTC','XRPBTC','BTTUSDT','ETHBTC','GXSBTC','ROSEBTC','ATOMBTC','MANABTC','STXBTC','SOLBTC','DOTBTC','MITHBTC','ALICEBTC', 'COCOSBNB', 'REQBTC', 'ALICEBTC', 'REQBTC', 'REQBTC']
